...
namespace RRGame
{
    public partial class PlayGame : Form
    {
        ...
        SoundPlayer player;
        int chance, chanceaway, Bulletposition, angle;
        Random random;
        Timer timer;
        ...
        private async void buttonSpin_Click(object sender, EventArgs e)
        {
            ...
            lblRemaining.Text = "Remaining Chance : " + chanceaway;
            Bulletposition = 0;
        }
        ...
        private async void buttonshootaway_Click(object sender, EventArgs e)
        {
            player = new System.Media.SoundPlayer();
            if (BulletCylinder.FireBullet(Bulletposition))
            {
